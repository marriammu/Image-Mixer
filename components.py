...
class inputimg():
    ...
    def __init__(self, imgPath: str):
        ...
        self.components ={"Magnitude": self.magnitude, "Phase":self.phaseshift, "Real":self.realshift,"Imaginary":self.imaginaryshift}
        self.Components={"Phase":self.phase ,"Magnitude":self.amplitude,"Real":self.real,"Imaginary":self.imaginary*1j,"Uniphase":self.uniphase,"Unimagnitude":self.unimag}
